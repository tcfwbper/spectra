...
- Must not: implement custom MarshalJSON — serialization of RuntimeError for persistence is entirely owned by SessionMetadataStore, which reads fields via getter methods.
