...
2. Ship a default SDD + scaffold-first workflow as a built-in implementation.
...
│                                                                 │
│  Built-in ────────────────────────────────────────────────────  │
│    Default Workflow: SDD + scaffold-first                       │
...
│                                                                 │
│  ── Example: Default SDD + scaffold-first workflow ──────────── │
│                                                                 │
